...
class OrderController extends Controller
{
	...
	public function print_order_convert($checkout_code){
		...
		<h1><center>Cửa hàng kinh doanh thiết bị di động Vietphone</center></h1>
		<h4><center>SẢN PHẨM CHẤT LƯỢNG - GIÁ CẢ HỢP LÝ - BẢO HÀNH LÂU DÀI</center></h4>
		<br>
		<br>
		<h2><center> HOÁ ĐƠN </center> </h2>
		<p>THONG TIN NGUOI DAT HANG</p>
	...
	public function view_order($order_code){
		...
		return view('admin.order.view_order')->with(compact('order_details','customer','shipping','getorder','order_status'));
