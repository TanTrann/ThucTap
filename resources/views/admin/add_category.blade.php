                   ...
                   <form role="form" action="{{URL::to('save-category')}}" method="post">
                    ...
                    <div class="row">
                      <div class="col-md-2">
                        ...
                        <br>
                                    <select  style="height: 30px ;width: 100px ; padding-left: 10px" name="category_status" input-sm m-bot15> 
                    ...
                    <button type="submit" class="btn btn-primary pull-right" name="add-category">Thêm danh mục</button>
