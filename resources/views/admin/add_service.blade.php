                            ...
                            <form action="{{URL::to('save-service')}}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        placeholder="Tên Dịch vụ" name="service_name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" 
                                        placeholder="Chi tiet dich vu" name="service_content">
                                    </div>
                                </div> 
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" 
                                        placeholder="Giá tiền" name="service_price">
                                    </div>
                                </div> 
                                ...
                                <div class="form-group row">
                                    ...
                                    <button class="btn btn-grd-success" style="float: right;" name="save-service">Thêm Dịch vụ</button>
                            </form>                                                                          
                        </div>
                    </div>                                                                        
                </div>
