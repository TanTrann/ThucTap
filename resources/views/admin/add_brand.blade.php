              ...
              <div class="card">
                ...
                <div class="card-body">
                   ...
                   <form role="form" action="{{URL::to('save-brand')}}" method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea style="resize :none" rows="8" name="brand_desc"  class="form-control" id="ckeditor1" > </textarea>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <button type="submit" class="btn btn-primary pull-right" name="add-brand">Thêm thương hiệu</button>
